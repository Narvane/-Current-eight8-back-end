package com.myportfolio.eightg.security;
...
public class UserPrincipal implements OAuth2User, UserDetails {
    ...
    public static UserPrincipal create(ApplicationUser applicationUser, Map<String, Object> attributes) {
        UserPrincipal userPrincipal = UserPrincipal.create(applicationUser);
